...
| [Grafana dashboard interoperability](grafana-dashboards.md) | Partially implemented |
| [Session layout: Layout/Grid/Focus views and contextual keys](session-layout.md) | Partially implemented |
| [Fixture-replay datasource](fixture-datasource.md) | Proposed |
